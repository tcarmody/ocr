...
swift test                  # 943 unit tests across 95 test files
```
...
├── Tests/                           943 unit tests across 95 test files
├── Resources/
