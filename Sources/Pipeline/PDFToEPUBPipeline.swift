...
public actor PDFToEPUBPipeline {
    ...
    public func convert(
        ...
        // P-Diagram-Description Tier 1. Per-region alt-text
        // generated by `ClaudeDiagramExtractor` for `.picture`
        // regions. Reflow swaps these in for `alt="figure"`
        // when present. Empty when Cloud diagram-description
        // is off or no `.picture` regions returned alt text.
        var diagramExtractionsByKey: [CaptionAssociator.PageRegionKey: DiagramExtractionResult] = [:]
        ...
        let cloudDiagramExtractor = cloudEngines.diagramExtractor
        ...
        if activePageEngine != nil {
            ...
            reflowed = Self.reflow(
                ...
                diagramExtractions: diagramExtractionsByKey,
